...
/// chain / a real `to` deploy to exercise for real; this pins the pure
/// routing + ledger arithmetic that decides where the SPL goes and how
/// much of the internal ledger moves.
