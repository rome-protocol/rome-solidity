...
| Re-admit holder and thaw for delegated-transfer proof | Passed | [allow](https://explorer.solana.com/tx/2B5NeQabKYjZTBfh838S7fu3NamvbsbTnKjj7mPm8TqJjqRSABsyLVBDw14Wst8f1Ke2JGhjrwrzxaf7SvmDMMEX?cluster=devnet), [thaw](https://explorer.solana.com/tx/zUgqLGwk9Zyss42UPFsuJ3YcgcELRiQrcsHCAJfZ2DwBswvVZiA9ppAoXQAAqsMMhpNzbA1xNGz6FP9feUP2WL4?cluster=devnet) |
| EVM holder approves, then EVM spender calls `transferFrom` for 1.000000 token | Passed; direct native ATA reads verified exact debit/credit | approve `0x49e3e62cd2790a065ea56c02b136fc2b8628723a9d26bb455160a514756b64eb`; transferFrom `0x8d2ce9939bdf13fccfa4ed6e46779d30e396d485aff55fea33d16d3316e012c2` |
| Final remove and freeze after delegated-transfer proof | Passed; final holder balance is 97.000000 and frozen | [remove](https://explorer.solana.com/tx/5iTUVYh2rJZ6GVR8WdvLFSBXWydt3anK3K2z8JzXtAakbWeRHKf15FWrvUaeUsy7Nu2modNoSSPKjAK46o3g3asD?cluster=devnet), [freeze](https://explorer.solana.com/tx/5vAoLxjGuAAqMwE2qTKtYKkbRZQB3K7P2tMFUPEbEkzBVcVs11vCVmMxuL3kpAUicWvG5AAR3wHpnCXMGYLnGQ7j?cluster=devnet) |
